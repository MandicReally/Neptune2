...
>cfg_screen_display_mode	1		#the style of display on the screen home(0:classic,1:simple,2:retro)
...
>DEFAULT_E0_STEPS_PER_UNIT	101.00	#Default Axis-E Steps Per Unit (steps/mm)
...
>EXTRUDE_MINTEMP 	170
>HEATER_0_MINTEMP	5		#ERR4,The minimum temperature of the nozzle is reported wrong, please check whether the thermistor is connected properly��
>HEATER_0_MAXTEMP 	275		#ERR2��
>HEATER_1_MINTEMP	5		#ERR4��The minimum temperature of the nozzle is reported wrong, please check whether the thermistor is connected properly��
>HEATER_1_MAXTEMP 	275		#ERR2��
>BED_MAXTEMP 		150		#ERR1��
>BED_MINTEMP		5		#ERR3,The lowest temperature of the hot bed is reported wrong, please check whether the thermistor is connected properly��

#======================== Thermal Runaway Protection =======================
>THERMAL_PROTECTION_PERIOD 		145     	#Seconds;When the machine frequently appears Err7, the current value can be appropriately increased.
>THERMAL_PROTECTION_HYSTERESIS 		5     	#Degrees Celsius
>WATCH_TEMP_PERIOD 			145	#Seconds;When the machine frequently appears Err5, the current value can be appropriately increased.
>WATCH_TEMP_INCREASE 			2	#Degrees Celsius
>THERMAL_PROTECTION_BED_PERIOD 		145    	#Seconds;When the machine frequently appears Err7, the current value can be appropriately increased.
>THERMAL_PROTECTION_BED_HYSTERESIS 	5 	#Degrees Celsius
>WATCH_BED_TEMP_PERIOD 			145      #Seconds;When the machine frequently appears Err6, the current value can be appropriately increased.
...
>X_PROBE_OFFSET_FROM_EXTRUDER	50.279	# X offset: -left  +right  [of the nozzle]
>Y_PROBE_OFFSET_FROM_EXTRUDER	-4.048	# Y offset: -front +behind [the nozzle]
...
>Z_CLEARANCE_DEPLOY_PROBE	5	# Z Clearance for Deploy/Stow	   > 0
...
>pid_adjustment_cmd:M303 C5 S200;			#PID Adjustment Instructions 

>MACHINE_PARAMETER		0			#Whether to use the online parameter adjustment function (0: not used, 1: used) 


#============================= Laser engraving /CNC =============================
>SPINDLE_LASER_ENABLE		0			#Laser engraving/CNC (1: enable, 0: disable) 
